...
extern bool __attribute__ ((noinline)) i2c_init(void) __attribute__ ((used));
extern bool __attribute__ ((noinline)) i2c_start(uint8_t addr) __attribute__ ((used)); 
extern void  __attribute__ ((noinline)) i2c_start_wait(uint8_t addr) __attribute__ ((used));
extern bool __attribute__ ((noinline)) i2c_rep_start(uint8_t addr) __attribute__ ((used));
extern void __attribute__ ((noinline)) i2c_stop(void) asm("ass_i2c_stop") __attribute__ ((used));
extern bool __attribute__ ((noinline)) i2c_write(uint8_t value) asm("ass_i2c_write") __attribute__ ((used));
extern uint8_t __attribute__ ((noinline)) i2c_read(bool last) __attribute__ ((used));
...
void LSM303::writeAccReg(byte reg, byte value)
{
  ...
  i2c_start(acc_address<<1 | I2C_WRITE);
  delayMicroseconds(INTERBYTE_DELAYUS);
  i2c_write(reg);
  delayMicroseconds(INTERBYTE_DELAYUS);
  i2c_write(value);
  i2c_stop();
...
byte LSM303::readAccReg(byte reg)
{
  ...
  i2c_start(acc_address<<1 | I2C_READ);
  delayMicroseconds(INTERBYTE_DELAYUS);
  value = i2c_read(true);
  i2c_stop();
...
void LSM303::writeMagReg(byte reg, byte value)
{
  ...
  i2c_start(mag_address<<1 | I2C_WRITE);
  delayMicroseconds(INTERBYTE_DELAYUS);
  i2c_write(reg);
  delayMicroseconds(INTERBYTE_DELAYUS);
  i2c_write(value);
...
byte LSM303::readMagReg(int reg)
{
  ...
  i2c_start(mag_address<<1 | I2C_READ);
  delayMicroseconds(INTERBYTE_DELAYUS);
  value = i2c_read(true);
  i2c_stop();
...
void LSM303::readAcc(void)
{
  ...
  delayMicroseconds(INTERBYTE_DELAYUS);
  byte xla = i2c_read(false);
  delayMicroseconds(INTERBYTE_DELAYUS);
  byte xha = i2c_read(false);
  delayMicroseconds(INTERBYTE_DELAYUS);
  byte yla = i2c_read(false);
  delayMicroseconds(INTERBYTE_DELAYUS);
  byte yha = i2c_read(false);
  delayMicroseconds(INTERBYTE_DELAYUS);
  byte zla = i2c_read(false);
  delayMicroseconds(INTERBYTE_DELAYUS);
  byte zha = i2c_read(true);
  i2c_stop();
...
void LSM303::readMag(void)
{
  ...
  i2c_start(mag_address<<1 | I2C_WRITE);
  delayMicroseconds(INTERBYTE_DELAYUS);
  i2c_write((_device == device_D) ? translated_regs[-OUT_X_L_M] | (1 << 7) : translated_regs[-OUT_X_H_M]);
  i2c_stop();
